...
% Last Modified by GUIDE v2.5 02-Oct-2023 20:02:38
...
set(handles.text7, 'String', num2str(T1))
SCARA28.d1.rotation = [0, 1, 0, T1*pi/180];
...
open(SCARA28)
T2=-get(handles.slider2,'value');
set(handles.text8, 'String', num2str(T2))
SCARA28.a2.rotation = [1, 0, 0, T2*pi/180];
...
open(SCARA28)
d4=-get(handles.slider4,'value');
set(handles.text9, 'String', num2str(-d4))
SCARA28.d4b.translation=[0,d4,0];
